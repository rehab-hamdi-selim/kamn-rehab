...
class AppPallete {
  static const Color greyFontColor = Color(0xff60708F);
  static const Color lightGreen = Color(0xff25EBA4);
  static const Color whiteColor = Colors.white;
  static const Color blackColor = Colors.black;
  static const Color lightWiteColor = Color(0xffFCFCFC);
  static const Color greyColor = Color(0xff8E8E93);
  static const Color shadeOfGray = Color(0xffF7F8FA);
  ...
  static const Color lightVividVioletColor = Color(0xffA95EFA);
  static const Color darkVividVioletColor = Color(0xff8A49F7);
  static const Color orangeAccentColor = Colors.orangeAccent;
  static const Color orangeColor = Color(0xffFF9B29);
  static const Color pinkColor = Color(0xffFF725E);
  static const Color blueColor = Color(0xff1A68D5);
  static const Color darkBlueColor = Color(0xff0002FC);
  ...
  static const Color tooLightGray = Color(0xffE0E0E0);
  static const Color accentBlackColor = Color(0xff1F1F1F);
  static const Color accentBlackColor2 = Color(0xff1E1E1E);
  static const Color blackColor2 = Color(0xff0D1634);
  static const Color dartBlackColor = Color(0xff000000);
  static const Color lightBlackColor2 = Color(0xff171717);
  ...
  static const Color lightWhiteColor = Color(0xffF5F6F6);
