...
class GymRequestModel {
  ...
  factory GymRequestModel.fromMap(Map<String, dynamic> map) {
    return GymRequestModel(
      ...
      imagesUrl: map['imagesUrl'] != null ? List<String>.from((map['imagesUrl'] as List<dynamic>)) : null,
      ...
      scoialMediaLinks: map['scoialMediaLinks'] != null ? List<ScoialMediaLink>.from((map['scoialMediaLinks'] as List<dynamic>).map<ScoialMediaLink?>((x) => ScoialMediaLink.fromMap(x as Map<String,dynamic>),),) : null,
