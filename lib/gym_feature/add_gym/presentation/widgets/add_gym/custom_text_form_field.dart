...
class CustomTextFormField extends StatelessWidget {
  ...
  const CustomTextFormField({super.key,
   this.hintText, required this.keyType,
    required this.lines, required this.controller, required this.boxhight,
    this.maxLength, required int maxLine, required this.label,  this.optionalText, this.sufixText, this.widget});
          ...
          maxLines: lines,
              maxLength: maxLength,
               buildCounter: maxLength != null?(context, {required currentLength, required isFocused, required maxLength}) {
                  ...
                  child: Text('$currentLength/($maxLength) character',style: TextStyle(
                                    fontSize: 10,
