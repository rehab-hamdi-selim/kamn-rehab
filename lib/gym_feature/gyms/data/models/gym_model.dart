...
class GymModel {
  ...
  factory GymModel.fromMap(Map<String, dynamic> map) {
    return GymModel(
      ...
      imageUrl: map['imageUrl'] != null ? List<String>.from((map['imageUrl'] as List<String>) ): null,
      logoUrl: map['logoUrl'] != null ? map['logoUrl'] as String : null,
      description: map['description'] != null ? map['description'] as String : null,
      phoneNumber: map['phoneNumber'] != null ? map['phoneNumber'] as String : null,
      ratings: map['ratings'] != null ? List<double>.from((map['ratings'] as List<double>)) : null,
      reviews: map['reviews'] != null ? List<String>.from((map['reviews'] as List<String>) ): null,
      offers: map['offers'] != null ? List<Plan>.from((map['offers'] as List<int>).map<Plan?>((x) => Plan.fromMap(x as Map<String,dynamic>),),) : null,
      socialMediaLinks: map['socialMediaLinks'] != null ? List<String>.from((map['socialMediaLinks'] as List<String>) ): null,
      features: map['features'] != null ? List<Feature>.from((map['features'] as List<int>).map<Feature?>((x) => Feature.fromMap(x as Map<String,dynamic>),),) : null,
      openDuration: map['openDuration'] != null ? List<OpenDuration>.from((map['openDuration'] as List<int>).map<OpenDuration?>((x) => OpenDuration.fromMap(x as Map<String,dynamic>),),) : null,
      isFullTimeAccess: map['isFullTimeAccess'] != null ? map['isFullTimeAccess'] as bool : null,
  ...
  factory GymModel.fromJson(String source) => GymModel.fromMap(json.decode(source) as Map<String, dynamic>);

  @override
  String toString() {
    return 'GymModel(id: $id, name: $name, uniqueName: $uniqueName, address: $address, imageUrl: $imageUrl, logoUrl: $logoUrl, description: $description, phoneNumber: $phoneNumber, ratings: $ratings, reviews: $reviews, offers: $offers, socialMediaLinks: $socialMediaLinks, features: $features, openDuration: $openDuration, isFullTimeAccess: $isFullTimeAccess, userId: $userId)';
  }
...
class Plan {
  ...
  factory Plan.fromMap(Map<String, dynamic> map) {
    return Plan(
      id: map['id'] != null ? map['id'] as String : null,
      name: map['name'] != null ? map['name'] as String : null,
      type: map['type'] != null ? OfferType.values.byName(map['type'] as String) : null,
      ...
      discountDuration: map['discountDuration'] != null ? DiscountDuration.fromMap(map['discountDuration'] as Map<String,dynamic>) : null,
...
class Feature {
  ...
  factory Feature.fromMap(Map<String, dynamic> map) {
    return Feature(
      ...
      price: map['price'] != null ? map['price'] as String : null,
      pricingOption: map['pricingOption'] != null ? PricingOption.values.byName(map['pricingOption'] as String) : null,
      description: map['description'] != null ? map['description'] as String : null,
    );
  }
...
class OpenDuration {
  ...
  factory OpenDuration.fromJson(String source) => OpenDuration.fromMap(json.decode(source) as Map<String, dynamic>);
...
class DiscountDuration {
  ...
  factory DiscountDuration.fromJson(String source) => DiscountDuration.fromMap(json.decode(source) as Map<String, dynamic>);
