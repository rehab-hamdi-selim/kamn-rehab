...
class CustomHomecookIngredientsForUpdate extends StatelessWidget {
  final List<Category> ingredients;
  final List<String> selectedIngredients;

  const CustomHomecookIngredientsForUpdate({
    super.key,
          ...
          child: SizedBox(
            ...
            child: GridView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                final isSelected = state.selectedMeal!.ingredients.contains(ingredient.name);
  ...
  Widget _ingredientItem(BuildContext context, Category ingredient, bool isSelected) {
    return InkWell(
      onTap: () => context.read<MealCubit>().toggleSelectionforUpdate(ingredient.name),
      child: SizedBox(
        height: 75.h,
        child: Column(
