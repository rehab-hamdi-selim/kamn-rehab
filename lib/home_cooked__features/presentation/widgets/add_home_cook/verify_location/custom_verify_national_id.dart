...
class CustomVerifyNationalIdField extends StatelessWidget {
  const CustomVerifyNationalIdField(
      {super.key,
      required this.title,
  ...
  Widget build(BuildContext context) {
    final bool isValid = index != null
        ? context.watch<AddHomeCookCubit>().state.isValid[index!]
        : true;
    return Column(
